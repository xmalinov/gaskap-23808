"""
Django settings for gaskap_23808 project.
...
ROOT_URLCONF = "gaskap_23808.urls"
...
WSGI_APPLICATION = "gaskap_23808.wsgi.application"
...
AUTHENTICATION_BACKENDS = (
    ...
    "users.auth_backends.AuthenticationBackend",
)
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [(env.str("REDIS_URL", "127.0.0.1"), 6379)],
        },
    },
}
